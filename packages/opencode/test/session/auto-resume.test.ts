...
const row = (info: SessionV1.Info, parts: SessionV1.Part[] = []) => ({ info, parts }) as SessionV1.WithParts
const aborted = () => new SessionV1.AbortedError({ message: "The operation was aborted." }).toObject()
