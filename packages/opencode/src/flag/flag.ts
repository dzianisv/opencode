...
export namespace Flag {
  ...
  export const OPENCODE_MCP_IDLE_MS = number("OPENCODE_MCP_IDLE_MS")
  export const OPENCODE_SESSION_IDLE_MS = number("OPENCODE_SESSION_IDLE_MS")

  export const OPENCODE_MEMORY_MONITOR = truthy("OPENCODE_MEMORY_MONITOR")
  export const OPENCODE_MEMORY_MONITOR_CHILDREN = truthy("OPENCODE_MEMORY_MONITOR_CHILDREN")
  export const OPENCODE_MEMORY_MONITOR_INTERVAL_MS = number("OPENCODE_MEMORY_MONITOR_INTERVAL_MS")
  export const OPENCODE_MEMORY_MONITOR_THRESHOLD_MB = number("OPENCODE_MEMORY_MONITOR_THRESHOLD_MB")
  export const OPENCODE_MEMORY_MONITOR_COOLDOWN_MS = number("OPENCODE_MEMORY_MONITOR_COOLDOWN_MS")
  export const OPENCODE_MEMORY_MONITOR_PATH = process.env["OPENCODE_MEMORY_MONITOR_PATH"]
