export const dict = {
  ...
  "command.models.autoreview.enable": "Enable auto-review",
  "command.models.autoreview.disable": "Disable auto-review",
  ...
  "prompt.action.voice.record": "Record voice input",
  "prompt.action.voice.starting": "Starting microphone",
  "prompt.action.voice.stop": "Stop voice input",
  "prompt.action.voice.speak": "Speak assistant replies",
  "prompt.action.voice.mute": "Mute spoken replies",
  ...
  "prompt.toast.voicePlaybackUnavailable.description": "This browser does not expose speech synthesis.",
  ...
  "toast.models.autoreview.on.title": "Auto-review enabled",
  "toast.models.autoreview.on.description": "Completed tasks will enqueue an automatic review follow-up",
  "toast.models.autoreview.off.title": "Auto-review disabled",
  "toast.models.autoreview.off.description": "Automatic review follow-ups are paused",
  ...
  "settings.models.section.session": "Session model behavior",
